...
const categorias = {
    ...
    profissoes: ["engenheiro","advogado","medico","professor","pescados"],
    cores:["amarelo","azul","roxo","vermelho","laranja","verde","branco"],
    animais:["vacalo","vaca","zebra","macaco","cachorro","gato","papagaio"]
};
